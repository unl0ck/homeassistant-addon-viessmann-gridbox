...
use your credentials from the Eon Gridbox Webseite https://eon.gridx.de/login
...
if you use an custom setup MQTT-Broker so you can add in the Addon the MQTT settings
