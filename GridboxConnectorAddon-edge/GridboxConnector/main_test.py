...
class TestGridboxConnectorMethods(unittest.TestCase):
    ...
    def test_main_heater(self, mock_retrieve_historical_data, mock_init, mock_init_auth,mock_mqtt_client):
        ...
        mqtt_pw = "mqtt_pw"
        mqtt_settings = Settings.MQTT(host=mqtt_server, username=mqtt_user, password=mqtt_pw)
        viessmann_gridbox_historical_device = HAViessmannGridboxConnector(mqtt_settings=mqtt_settings, device_name="Viessmann Gridbox Historical", device_identifiers="viessmann_gridbox_historical", prefix="historical", unit_of_power="Wh", device_class_of_power="energy", state_class="total")
